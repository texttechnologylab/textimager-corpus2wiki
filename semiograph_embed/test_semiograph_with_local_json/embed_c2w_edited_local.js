$(document).ready(function ()
{
	...
	$('.embeddingviz').each(function (ind)
	{
		...
		var content = '<div style="float:left;">' +
			...
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(31, 119, 180, 1);">DDC 000 Computer science, knowledge & systems</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(255, 127, 14, 0.75)">DDC 100 Philosophy</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(44, 160, 44, 0.75)">DDC 200 Religion</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(214, 39, 40, 0.75);">DDC 300 Social sciences, sociology & anthropology</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(148, 103, 189, 0.75);">DDC 400 Language</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(140, 86, 75, 0.75);">DDC 500 Science</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(227, 119, 194, 0.75);">DDC 600 Technology</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(127, 127, 127, 0.75);">DDC 700 Arts</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(188, 189, 34, 0.75);">DDC 800 Literature, rhetoric & criticism</li>' +
			'<li style="margin-left: 0px; padding: 5px; list-style-type: none; background-color:rgba(23, 190, 207, 0.75);">DDC 900 History</li>' +
			'</ul>' +
			'</div>' +
			'<div class="vizdiv" style="position:absolute;">' +
			'</div>';
