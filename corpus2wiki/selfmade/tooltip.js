        ...
        _content_insert: function () {
            ...
            if (!self.options.contentAsURL) {
                ...
                if (self.options.contentAsTabs) {
                    ...
                    tabsList.setAttribute('class', 'tab-links');
                    ...
                    tmp.appendChild(tabs);
                    tmp.appendChild(tab_content);


                    $d.empty().append(tmp.innerHTML);
                }
                else {
                    var toolTipHTML = self.httpGet(self.Content);
                    //console.log(toolTipHTML);
                    $d.empty().append(toolTipHTML);
                }
            }
        },
